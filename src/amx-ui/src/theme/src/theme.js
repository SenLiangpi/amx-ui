...
function isObject (obj, name) {
  ...
  if (!res) {
    console.error(`AMX UI @ theme-system @ theme config ${name || ''} should be an object`)
  }
  return res
}
...
export default function (config) {
  ...
  let styleTag = document.querySelector('style#amx-ui-theme') || document.createElement('style')
  styleTag.id = 'amx-ui-theme'
